...
<nav class="site-header sticky-top py-1">
    ...
    <form name="edShort" method="post" action="editaS.php" align="center">
    ...
    <input type="hidden" name="idShort" value="<?php echo $idShort;?>"> 
        ...
        ?>
<div class="col-md-12 order-md-1">
                <form class="needs-validation" action="editaS.php" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="custom-select d-block w-100" id="marca" name="marca" required="" value="<?php echo $marca; ?>">
                                <option value=""><?php echo $marca; ?></option>
