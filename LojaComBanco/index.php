        ...
        <div class="container">
            ...
            <hr size="5">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach($pdo->query($sql)as $row)
                            {
                                ...
                                echo '<td width=250>';
                                echo '<p align="center"> <a class="button button3" href="excluircamiseta.php?idCamiseta='.$row['idCamiseta'].'" >Excluir</a>' . "   " 
                ...
                <div class="row">
                    ...
                    <thead class = "table-secondary">
                        ...
                        <tbody>
                            ...
                            foreach($pdo->query($sql)as $row)
                            {
                                ...
                                echo '<td width=250>';
                                echo ' <p align="center"> <a class="button button3" href="excluirshort.php?idShort='.$row['idShort'].'">Excluir</a>' . '     
                    ...
                    <p align="center"> 
                    <a href="cadastroCamiseta.html" class="btn btn-outline-success"> Adiconar ao estoque</a>
                    </p>
                    <br>
                    <br>
                </div>
                    ...
                    <thead class="table-secondary">
                        ...
                        <tbody>
                            ...
                            foreach($pdo->query($sql)as $row)
                            {
                                ...
                                echo '<td width=250>';
                                echo '<p align="center"> <a class="btn btn-outline-danger" href="excluirtenis.php?idTenis='.$row['idTenis'].'">Excluir</a>' . '     
                                 <a class="btn btn-outline-warning" href="edita-tenis.php?idTenis='.$row['idTenis'].'">Editar</a>';
                                echo '</td>';
                                echo '</tr>';
                            }
                            Conexao::desconectar();
